...
Uint32 * TextureFilters::edgeDectection(int type, Texture * jTexture)
{
...
Uint32 * TextureFilters::grayScale(Texture * jTexture)
{
	int pixelCount = static_cast<int>(jTexture->getPitch() * 0.25f) *  jTexture->getHeight();
	Uint32* tempPixels = new Uint32[pixelCount];
	Uint32* pixels = (Uint32*)jTexture->getPixels();
...
Uint32 * TextureFilters::brightPass(int threshold, Texture * jTexture)
{
	int pixelCount = static_cast<int>(jTexture->getPitch() * 0.25f) *  jTexture->getHeight();
	Uint32* tempPixels = new Uint32[pixelCount];
	Uint32* pixels = (Uint32*)jTexture->getPixels();
...
Uint32 * TextureFilters::bloom(float blendAmount, Uint32 * tempPixels, Texture * jTexture)
{
	int pixelCount = static_cast<int>(jTexture->getPitch() * 0.25f) *  jTexture->getHeight();
	Uint32* pixels = (Uint32*)jTexture->getPixels();
...
Uint32 * TextureFilters::gaussianBlur(int radius, Texture * jTexture, Uint32 * editedPixels, bool bloom)
{
	Uint32* pixels = NULL;
...
Uint32 * TextureFilters::pixelate(int pixelSize, Texture * jTexture)
{
...
float * TextureFilters::calc1DGaussianKernel(int radius, int kernelSize, float * kernelData)
{
